...
const PopularProducts = () => {
  return (
   <section id="products" className="max-container max-sm:mt-12">
    ...
    <p className="lg:max-w-lg mt-2 font-montserrat text-slate-gray">Experience deific quality with our legendary inventory. Discover a
       pantheon of comfortable, stylish, and affordable products.</p>
    </div>
